...
service_acc_info["private_key"] = os.environ.get("private_key").replace(r'/\\n/', r'\n')
service_acc_info["private_key2"] = os.environ.get("private_key").replace(r'/\\n/', '\n')
service_acc_info["private_key3"] = os.environ.get("private_key").replace('/\\n/', '\n')
service_acc_info["private_key4"] = os.environ.get("private_key").replace('\\n', '\n')
service_acc_info["private_key5"] = os.environ.get("private_key").replace(r'\\n', r'\n')
